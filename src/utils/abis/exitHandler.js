module.exports = [
  {
    ...
    name: 'verifications',
    outputs: [{ name: 'startTime', type: 'uint32' }, { name: 'owner', type: 'address' }, { name: 'stake', type: 'uint256' }],
    payable: false,
  ...
  {
    constant: false,
    inputs: [{ name: '_token', type: 'address' }, { name: '_isERC721', type: 'bool' }],
    name: 'registerToken',
    outputs: [],
    payable: false,
  ...
  {
    constant: false,
    inputs: [{ name: '_owner', type: 'address' }, { name: '_amountOrTokenId', type: 'uint256' }, { name: '_color', type: 'uint16' }],
    name: 'deposit',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'tokens',
    outputs: [{ name: 'addr', type: 'address' }, { name: 'currentSize', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, name: 'tokenAddr', type: 'address' }, { indexed: false, name: 'color', type: 'uint16' }],
    name: 'NewToken',
    type: 'event',
  },
  {
  ...
  {
    constant: false,
    inputs: [{ name: '_bridge', type: 'address' }, { name: '_exitDuration', type: 'uint256' }, { name: '_exitStake', type: 'uint256' }],
